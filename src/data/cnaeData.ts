...
export const CNAE_DATA: CnaeEntry[] = [
    ...
    {
        "code": "0128",
        "description": "Cultivo de especias, plantas aromáticas, medicinales y farmacéuticas",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    },
    {
        ...
        "agents": [
            ...
            },
            {
                ...
                "context": "[Cancerígeno ] HIDROC AROMATICOS - Carc. 1B, Muta. 1B, Repr. 1B"
            },
            {
                "name": "NIQUEL",
    ...
    {
        "code": "0170",
        "description": "Caza, captura de animales y servicios relacionados con las mismas",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "0811",
        "description": "Extracción de piedra ornamental y para la construcción, piedra caliza, yeso, creta y pizarra",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "0812",
        "description": "Extracción de gravas y arenas, extracción de arcilla y caolín",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "0891",
        "description": "Extracción de minerales para productos químicos y fertilizantes",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "0910",
        "description": "Actividades de apoyo a la extracción de petróleo y gas natural",
        "agents": [
            {
                "name": "ARSENICO",
                "context": "[Cancerígeno ] ARSENICO - Carc. 1A"
    ...
    {
        "code": "1091",
        "description": "Fabricación de productos para la alimentación de animales de granja",
        "agents": [
            {
                "name": "NIQUEL",
                "context": "[Cancerígeno ] NIQUEL - Carc. 1A, Muta. 2, Repr. 1B"
    ...
    {
        "code": "1092",
        "description": "Fabricación de productos para la alimentación de animales de compañía",
        "agents": [
            {
                "name": "NIQUEL",
                "context": "[Cancerígeno ] NIQUEL - Carc. 1A, Muta. 2, Repr. 1B"
    ...
    {
        "code": "1392",
        "description": "Fabricación de artículos confeccionados con textiles, excepto prendas de vestir",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "1396",
        "description": "Fabricación de otros productos textiles de uso técnico e industrial",
        "agents": [
            {
                "name": "NIQUEL",
                "context": "[Cancerígeno ] NIQUEL - Carc. 1A, Muta. 2, Repr. 1B"
    ...
    {
        "code": "1420",
        "description": "Actividades de servicios relacionados con la ganadería, excepto actividades veterinarias",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "1511",
        "description": "Preparación, curtido y acabado del cuero, preparación y teñido de pieles",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "1512",
        "description": "Fabricación de artículos de marroquinería, viaje y de guarnicionería y talabartería",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "1623",
        "description": "Fabricación de otras estructuras de madera y piezas de carpintería y ebanistería para la construcción",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "1629",
        "description": "Fabricación de otros productos de madera, artículos de corcho, cestería y espartería",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "1721",
        "description": "Fabricación de papel y cartón ondulados, fabricación de envases y embalajes de papel y cartón",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "1722",
        "description": "Fabricación de artículos de papel y cartón para uso doméstico, sanitario e higiénico",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    },
    {
        ...
        "agents": [
            ...
            },
            {
                ...
                "context": "[Cancerígeno ] CADMIO (inhalable) - Carc. 1B, Muta. 1B, Repr. 1B"
            },
            {
                "name": "CADMIO (respirable)",
                "context": "[Cancerígeno ] CADMIO (respirable) - Carc. 1B, Muta. 1B, Repr. 1B"
            },
            {
                "name": "CLORURO DE VINILO",
                "context": "[Cancerígeno ] CLORURO DE VINILO - Carc. 1A"
    ...
    {
        "code": "2030",
        "description": "Fabricación de pinturas, barnices y revestimientos similares, tintas de imprenta y masillas",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2041",
        "description": "Fabricación de jabones, detergentes y otros artículos de limpieza y abrillantamiento",
        "agents": [
            {
                "name": "AMIDA",
                "context": "[Cancerígeno ] AMIDA - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2319",
        "description": "Fabricación y manipulado de otro vidrio, incluido el vidrio técnico",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2332",
        "description": "Fabricación de ladrillos, tejas y productos de tierras cocidas para la construcción",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2341",
        "description": "Fabricación de artículos cerámicos de uso doméstico y ornamental",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2399",
        "description": "Fabricación de otros productos minerales no metálicos n.c.o.p.",
        "agents": [
            {
                "name": "NIQUEL",
                "context": "[Cancerígeno ] NIQUEL - Carc. 1A, Muta. 2, Repr. 1B"
    ...
    {
        "code": "2410",
        "description": "Fabricación de productos básicos de hierro, acero y ferroaleaciones",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2420",
        "description": "Fabricación de tubos, tuberías, perfiles huecos y sus accesorios, de acero",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2521",
        "description": "Fabricación de radiadores y calderas para calefacción central",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2529",
        "description": "Fabricación de otras cisternas, grandes depósitos y contenedores de metal",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2530",
        "description": "Fabricación de generadores de vapor, excepto calderas para calefacción central",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2651",
        "description": "Fabricación de instrumentos y aparatos de medida, verificación y navegación",
        "agents": [
            {
                "name": "BERILIO",
                "context": "[Cancerígeno ] BERILIO - Carc. 1B"
    ...
    {
        "code": "2660",
        "description": "Fabricación de equipos de radiación, electromédicos y electroterapéuticos",
        "agents": [
            {
                "name": "ARSENICO",
                "context": "[Cancerígeno ] ARSENICO - Carc. 1A"
    ...
    {
        "code": "2732",
        "description": "Fabricación de otros hilos y cables electrónicos y eléctricos",
        "agents": [
            {
                "name": "BERILIO",
                "context": "[Cancerígeno ] BERILIO - Carc. 1B"
    ...
    {
        "code": "2811",
        "description": "Fabricación de motores y turbinas, excepto los destinados a aeronaves, vehículos automóviles y ciclomotores",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2815",
        "description": "Fabricación de cojinetes, engranajes y órganos mecánicos de transmisión",
        "agents": [
            {
                "name": "HIDROC AROMATICOS",
                "context": "[Cancerígeno ] HIDROC AROMATICOS - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2823",
        "description": "Fabricación de máquinas y equipos de oficina, excepto equipos informáticos",
        "agents": [
            {
                "name": "HIDROC AROMATICOS",
                "context": "[Cancerígeno ] HIDROC AROMATICOS - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2825",
        "description": "Fabricación de maquinaria de ventilación y refrigeración no doméstica",
        "agents": [
            {
                "name": "HIDROC AROMATICOS",
                "context": "[Cancerígeno ] HIDROC AROMATICOS - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2892",
        "description": "Fabricación de maquinaria para las industrias extractivas y de la construcción",
        "agents": [
            {
                "name": "HIDROC AROMATICOS",
                "context": "[Cancerígeno ] HIDROC AROMATICOS - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2893",
        "description": "Fabricación de maquinaria para la industria de la alimentación, bebidas y tabaco",
        "agents": [
            {
                "name": "HIDROC AROMATICOS",
                "context": "[Cancerígeno ] HIDROC AROMATICOS - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2894",
        "description": "Fabricación de maquinaria para las industrias textil, de la confección y del cuero",
        "agents": [
            {
                "name": "HIDROC AROMATICOS",
                "context": "[Cancerígeno ] HIDROC AROMATICOS - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2896",
        "description": "Fabricación de maquinaria para las industrias del plástico y del caucho",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2899",
        "description": "Fabricación de otra maquinaria para usos específicos n.c.o.p.",
        "agents": [
            {
                "name": "HIDROC AROMATICOS",
                "context": "[Cancerígeno ] HIDROC AROMATICOS - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2920",
        "description": "Fabricación de carrocerías para vehículos de motor, fabricación de remolques y semirremolques",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2931",
        "description": "Fabricación de equipos eléctricos y electrónicos para vehículos de motor",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "2932",
        "description": "Fabricación de otros componentes, piezas y accesorios para vehículos de motor",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "3101",
        "description": "Fabricación de muebles de oficina y de establecimientos comerciales",
        "agents": [
            {
                "name": "CADMIO",
                "context": "[Cancerígeno ] CADMIO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "3250",
        "description": "Fabricación de instrumentos y suministros médicos y odontológicos",
        "agents": [
            {
                "name": "BERILIO",
                "context": "[Cancerígeno ] BERILIO - Carc. 1B"
    ...
    {
        "code": "3516",
        "description": "Producción de energía eléctrica de origen térmico convencional",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "3900",
        "description": "Actividades de descontaminación y otros servicios de gestión de residuos",
        "agents": [
            {
                "name": "AMIANTO",
                "context": "[Cancerígeno ] AMIANTO - Carc. 1B, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "4672",
        "description": "Comercio al por mayor de repuestos y accesorios de vehículos de motor",
        "agents": [
            {
                "name": "NIQUEL",
                "context": "[Cancerígeno ] NIQUEL - Carc. 1A, Muta. 2, Repr. 1B"
    ...
    {
        "code": "4540",
        "description": "Venta, mantenimiento y reparación de motocicletas y de sus repuestos y accesorios",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "4611",
        "description": "Intermediarios del comercio de materias primas agrarias, animales vivos, materias primas textiles y productos semielaborados",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "4612",
        "description": "Intermediarios del comercio de combustibles, minerales, metales y productos químicos industriales",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "4613",
        "description": "Intermediarios del comercio de la madera y materiales de construcción",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "4616",
        "description": "Intermediarios del comercio de textiles, prendas de vestir, peletería, calzado y artículos de cuero",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "4644",
        "description": "Comercio al por mayor de porcelana, cristalería y artículos de limpieza",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "4652",
        "description": "Comercio al por mayor de equipos electrónicos y de telecomunicaciones y sus componentes",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "4664",
        "description": "Comercio al por mayor de maquinaria para la industria textil y de máquinas de coser y tricotar",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "4777",
        "description": "Comercio al por menor de artículos de relojería y joyería en establecimientos especializados",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
    ...
    {
        "code": "7219",
        "description": "Otra investigación y desarrollo experimental en ciencias naturales y técnicas",
        "agents": [
            {
                "name": "AMINA",
                "context": "[Cancerígeno ] AMINA - Carc. 1A, Muta. 1B, Repr. 1B"
    ...
    {
        "code": "7220",
        "description": "Investigación y desarrollo experimental en ciencias sociales y humanidades",
        "agents": [
            {
                "name": "NIQUEL",
                "context": "[Cancerígeno ] NIQUEL - Carc. 1A, Muta. 2, Repr. 1B"
    ...
    {
        "code": "9521",
        "description": "Reparación de aparatos electrónicos de audio y vídeo de uso doméstico",
        "agents": [
            {
                "name": "SILICE",
                "context": "[Cancerígeno ] SILICE - Carc. 1A"
